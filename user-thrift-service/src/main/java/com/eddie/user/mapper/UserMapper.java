...
public interface UserMapper {
    ...
    @Select("select id,USER_NAME,USER_PASSWORD,REAL_NAME,USER_MOBILE,USER_EMAIL FROM PE_USER WHERE ID=#{id}")
    UserInfo getUserById(@Param("id")int id);

    @Select("select id,USER_NAME,USER_PASSWORD,REAL_NAME,USER_MOBILE,USER_EMAIL FROM PE_USER WHERE USER_NAME=#{name}")
